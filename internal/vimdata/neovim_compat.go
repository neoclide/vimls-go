...
var neovimCompatVariables = []Variable{
	...
	{Name: "v:argf", Type: "any"},
	{Name: "v:exitreason", Type: "any"},
	{Name: "v:relnum", Type: "any"},
	{Name: "v:starttime", Type: "any"},
	{Name: "v:termrequest", Type: "any"},
	{Name: "v:virtnum", Type: "any"},
}
