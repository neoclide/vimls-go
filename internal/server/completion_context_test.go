...
func TestCompletionContextSpecificAndRejectedSyntax(t *testing.T) {
	cases := []struct {
		...
		{"augroup Pro", "Pro", completionContextAugroup}, {"command -co", "-co", completionContextUserCommandAttribute}, {"command! -co", "-co", completionContextUserCommandAttribute}, {"command! -", "-", completionContextUserCommandAttribute}, {"command! -nargs=+ -", " -", completionContextUserCommandAttribute}, {"command -nargs=", "-nargs=", completionContextUserCommandAttributeValue}, {"command! -nargs=", "-nargs=", completionContextUserCommandAttributeValue},
		{"function! Foo() ", "Foo() ", completionContextFunctionAttribute}, {"function! Foo() ab", "ab", completionContextFunctionAttribute}, {"function! Foo() abort cl", "cl", completionContextFunctionAttribute},
		{"vim9script\nfunction Foo() di\nendfunction", "di", completionContextFunctionAttribute}, {"vim9script\ndef Foo() ab\nenddef", "ab", completionContextExpression},
		...
		{"vim9script\ndef Run()\n  :\nenddef", ":", completionContextCommand},
		{"vim9script\ndef Run()\n  :echo 1\nenddef", ":echo", completionContextCommand},
		{"vim9script\ndef Run()\n  enddef\n", "enddef", completionContextCommand},
