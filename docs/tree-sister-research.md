...
> `Reparse`、checkpoint、收敛或 clone/rebase 方案。当前实施契约见
> [Incremental editing and parser cache](architecture.md#incremental-editing-and-parser-cache)：
> LSP edit 只增量合成文本，变化内容始终完整解析。
